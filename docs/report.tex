...
This report aims to explain the more involved implementation details of our multi-resolution freeform modelling tool.
...
In addition, mathematical context is given for the occurring parameters, many of which are exposed to the user to allow for experimentation and adjustments for varying environments.
...
We implement a multi-resolution editing approach based on point wise displacement vectors, as described in \cite{bibid}.
